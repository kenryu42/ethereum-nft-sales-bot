...
import { Auth, ENFT } from '../../src/index.js'; // Change the path to 'enft' if you are using the package

import type { TransactionData } from '../../src/index.js'; // Change the path to 'enft' if you are using the package
...
if (!txHash || !contract) {
    ...
    console.log(
        'Usage: ts-node example/ts/debugTransaction.ts <contract> <txHash>'
    );
    process.exit(1);
}
